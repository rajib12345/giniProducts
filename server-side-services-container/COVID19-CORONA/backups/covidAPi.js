...
let covid19_india_zones_report_template_arglist = [
  {key : "zone", subkey: null, type: "block", prefixValue: '<span style="float: left; color: white; font-weight: 700;"> Zone </span>', sharedObj : 'title',  postfixValue: '', ellipse : 'none', style: "color: white; font-size: 16px;  position: relative; text-align: right; font-weight: 700;"},
  {key : "district", subkey: null, type: "block", prefixValue: '', sharedObj : 'title',  postfixValue: '', ellipse : 'none', style: "color: white;  font-size: 24px;  position: relative;  margin-top: 3px; font-weight: 600;"},
  {key : "date", subkey: null, type: "block", prefixValue: '<span class="glyphicon glyphicon glyphicon-time" style="color: white; position: relative; top: 5px; font-size: 18px; margin-right: 5px; font-weight: 700; "></span>', sharedObj : 'title',  postfixValue: '', ellipse : 'none', style: " font-size: 14px;  position: relative; margin-top: 3px; color: white; font-weight: 700;"},
  ...
  {key : "", subkey: null, type: "button", btnName: '<span class="glyphicon glyphicon-new-window" style="color: blue; position: relative; top: 4px; font-size: 16px; margin-right: 5px; "></span> Source', onclick: {methodName: 'onOpenModal', params: ['source'], defaults: ['newWindow'] },  style: 'width: 100%; background-color: white; color: blue; border: none;  border-radius: 0px; position: relative; top: 5px; '},
...
let github_covid19_daily_report_template_arglist = [
  ...
  {key : "compareToPreviousDay", subkey: null, type: "block", prefixValue: '', sharedObj : 'title',  postfixValue: '', ellipse : 'none', style: "color: "+default_style.themeColor+";  font-size: 14px;  position: relative; margin-top: 3px; margin-bottom: 3px; text-align: center; font-weight: 600;"},
...
let github_covid19_india_testing_by_india_govt_report_template_arglist = [
  ...
  {key : "", subkey: null, type: "button", btnName: '<span class="glyphicon glyphicon-open-file" style="color: orange;"></span> Open File', onclick: {methodName: 'onOpenModal', params: ['source'], defaults: ['open_pdf_in_modal'] },  style: 'width: 100%; background-color: white; color: #4b4f56; border: none; border-top: 1px solid #ccd0d5; border-radius: 0px; position: relative; top: 9px; '},

]

let who_covid19_question_and_answer_template_arglist = [
    {key : "image", subkey: null, type: "image", api: 'GITHUB:covid19_api',  style:'width: 100%; height: 150px; border: none;'},
    ...
    {key : 'who', subkey: null, type: 'customIcon', charCutOff: 2, charCutOffDirection: 'start',  style: 'background-color: #49A2C5; color: white; font-weight: 700; display: inline-block; width: 40px; height: 40px; text-align: center; padding-top: 11px; margin-top: 10px;'},
    {key : 'url', subkey: null, type: 'openUrlInNewTab', prefixValue: '', postfixValue: '', ellipse : '',  style: 'font-size: 16px; color: brown; display: inline-block; margin-left: 6px; color: #49A2C5; position: relative; top: 3px;'},
];
...
let covid19_india_state_wise_testing_lab_information_template_arglist = [
  ...
  {key : "nameoftheorganisation", subkey: null, type: "block", prefixValue: '', sharedObj : 'text', postfixValue: '', ellipse : 'none', style:'color: black; font-size: 18px; text-align: center; font-weight: 600;'},
  {key : "category", subkey: null, type: "block", prefixValue: '', sharedObj : 'title',  postfixValue: '', ellipse : 'none',  style: "color: #4b4f56; font-size: 16px; margin-top: 8px; font-weight: 700; margin-top: 8px;"},
...
function createOverAllIndianPredictionReport(request, socket){
    ...
    let obj = {
      ...
      dailyDeath: SERVER_SIDE_INIT_DATA.covid19_india_last_record_date_daily_overall_changes.confirm,
    ...
    // rajib
    let template = `
    <div style="background-color: antiquewhite; padding-top: 12px; padding-bottom: 12px;">
        <center><div style="font-size: 20px; color: #607D8B; font-weight: 600;">Analysis Based On The Last Record</div></center>
        <div style=" width: 60%; margin: auto; margin-top: 10px;">
                ...
                <div style="display: inline-block; width: 50%;">
                    ...
                    <div>`+SERVER_SIDE_INIT_DATA.covid19_india_last_record_date_report.confirmed+`</div>
                    <div>`+SERVER_SIDE_INIT_DATA.covid19_india_last_record_date_report.deaths+`</div>
                </div>
        </div>
        <div style="width: 100%; margin-top: 16px; margin-bottom: 16px;">
          <div style="text-align: center; margin-bottom: 10px;">
              <span>------</span>
              <span>Prediction After <span id="stateWiseDailyChangeDays_counter" style="font-size: 24px;font-weight: 600;" >10</span> days </span>
              <span>------</span>
          </div>
            ...
            <div style="width: 100%; padding-right: 16px;">
                  <div style="display: inline-block; width: 20%;">
                      <div style="height: 30px; ">
                          <button type="button" id="stateWiseDailyChangeDays_minusBtn" data=`+obj+`  onclick="onClickStateWiseDailyChangeDaysMinusBtn(event)" style="border: none; outline: none !important; font-size: 20px; background-color: rgb(233, 235, 238); height: 31px; width: 36px;">-</button>
                        </div>
                    </div>
                    <div style="display: inline-block; width: 60%; text-align: center;">
                      <input type="text" id="stateWiseDailyChangeDays_inputText" data=`+obj+` value="10" onChange="onChnageStateDailyChange(event)" style="width: 90%; height: 32px; border: 1px solid `+default_style.borderColor+`; position: relative; left: 10px; padding-left: 16px; top: -2px;"></input>
                    </div>
                    <div style="display: inline-block; width: 10%;">
                      <button type="button" id="stateWiseDailyChangeDays_plusBtn" data=`+obj+` onclick="onClickStateWiseDailyChangeDaysPlusBtn(event)" style="border: none; outline: none !important; font-size: 20px; background-color: rgb(233, 235, 238); height: 31px; width: 36px;">+</button>
                    </div>
                </div>
          </div>
            <div style="width: 60%; display: inline-block; border-left: 1px solid `+default_style.borderColor+`; padding-left: 16px;">
          ...
          if(request.category === "githuib_covid19_global_report" || request.category === "githuib_covid19_global_daily_report_by_date" ){
              ...
              response = response["zones"];
                ...
                response.forEach(function(item){
                    if(index_arr.indexOf(item.state) === -1){
                        let arr = [];
                        item.descriptionTemplateBgColor = item.zone.toLowerCase();
              ...
              let districtWiseReportFooterBlock =  `
                <div>
                  ...
                  <div style="background-color: antiquewhite; padding-top: 12px; padding-bottom: 12px;">
                      <center><div style="font-size: 20px; color: #607D8B; font-weight: 600;">Analysis Based On The Record</div></center>
                      <div style=" width: 60%; margin: auto; margin-top: 10px;">
                              <div style="display: inline-block; width: 50%; float: left;">
                              	  <div>Date </div>
                                  <div>Confirm Case </div>
...
// https://www.countryflags.io/in/flat/64.png
    ...
    if(request.scrollType !== null && request.scrollType !== undefined && request.scrollType === "vertical"){
      ...
      if(request.category === "githuib_covid19_india_latest_report"){
          ...
          payload.style.defaults.margin = '0px 8px 0px 0px';
          payload.style.defaults.padding = '16px 10px 10px 10px';
          payload.style.defaults.style = "border: 1px solid"+default_style.borderColor+";";
          //payload.style.defaults.descriptionTemplateStyle += "padding-left: 0px; padding-right: 8px;";
          payload.style.defaults.imageTemplateStyle = "text-align: center;";

      }else if(request.category === "who_covid19_question_and_answer"){
          payload.style.defaults.width = "340px";
          payload.style.defaults.style= "padding: 0px; margin: 0px 8px 0px 0px; border: 1px solid "+default_style.borderColor+";";
      }else if(request.category === "githuib_covid19_india_district_wise_report_new"){
          ...
          if(request.category === "githuib_covid19_india_state_wise_report"){
              payload.style.defaults.width = "300px";
              payload.style.defaults.style = "border: 1px solid "+default_style.borderColor+"; border-radius: 0px; ";
          ...
          payload.style.defaults.margin = '0px 8px 0px 0px';
          payload.style.defaults.padding = '0px 0px 0px 0px';
          // argList[0].style = 'width: 100%; height: 100%;';
          payload.style.defaults.style="border-radius: 0px; border: 1px solid #ccd0d5; "
      }else if(request.category === "githuib_covid19_country_wise_report"){
          payload.style.imgPos = "none";
          payload.style.defaults.width = "300px";
          ...
          argList[0].style = "height: 40px; width: 60px; border: none; position: relative; display: inline-block; float: right; right: 1px; object-fit: fill; border-radius: 5px;";
          payload.style.defaults.margin = '10px 8px 0px 0px';
          ...
          payload.style.defaults.margin = '0px 8px 0px 0px';
          payload.style.defaults.padding = '0px 0px 0px 0px';
          payload.style.defaults.style = "border: 1px solid #ccd0d5;";
      }else if(request.category === "githuib_covid19_india_time_series_by_india_govt_report"){
          payload.style.defaults.width = "320px";
          payload.style.defaults.margin = '0px 8px 0px 0px';
          payload.style.defaults.padding = '0px 0px 0px 0px';
          ...
          payload.style.defaults.margin = '0px 8px 0px 0px';
          payload.style.defaults.padding = '10px 10px 10px 10px';
          payload.style.defaults.style = "border: none; border-bottom: none;";
      }else if(request.category === 'githuib_covid19_india_compare_states_data'){
          payload.style.imgPos = "left";
          payload.style.defaults.width = "100%";
          ...
          if(request.category === "githuib_covid19_india_state_wise_death_recoveries_report"){
            ...
            payload.style.defaults.width = "330px";
            payload.style.defaults.margin = '0px 8px 0px 0px';
            payload.style.defaults.top = "0px";
            payload.style.defaults.style = "border-width: 6px 1px 1px 1px; border-color: "+default_style.themeColor+"; border-style: solid; ";
          }else{
            payload.style.imgPos = "none";
            payload.style.defaults.padding = '16px 10px 10px 10px';
            payload.style.defaults.width = "330px";
            payload.style.defaults.margin = '0px 8px 0px 0px';
            payload.style.defaults.top = "0px";
            payload.style.defaults.style = "border-width: 6px 1px 1px 1px; border-color: "+default_style.themeColor+"; border-style: solid; height: 230px; ";
          }
