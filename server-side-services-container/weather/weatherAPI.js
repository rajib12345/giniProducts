...
const darkSkyApiKey = "93e9df5d304b8ae70a0b2b9091bd41f7";
const darkskyUrl = "https://api.darksky.net/forecast/93e9df5d304b8ae70a0b2b9091bd41f7/22.769,88.371";
...
var processWeather = function(resObj, dummySocket, apiResponseObj, accessFrom){
    var returnMsg = '';
               ...
               fetchRealTimeWeatherData(currentCity).then(function(data){
                     let returnMsg = '';
                      ...
                      if(accessFrom === "application"){
                          ...
                          apiResponseObj.json({data : {AI_RESPONSE_JSON: resObj, AI_RESPONSE_HTML: returnMsg}})
                      }
               });

          });
         // IPINFO_SERVICE.getIpInfo().then(function(ipInfo){
         //       console.log("=== in weatherAPI.js the ipinfo is ===", ipInfo);
         //       let currentCity = ipInfo.city;
         //       fetchRealTimeWeatherData(currentCity).then(function(data){
         //             let returnMsg = '';
